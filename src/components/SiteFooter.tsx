          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-6">
            <a href={`mailto:${SITE.email}`} className="group flex items-start gap-4">
              ...
              <div className="min-w-0 text-left">
                ...
                <div className="mt-0.5 text-sm text-white break-all group-hover:text-gold-soft transition">
                  {SITE.email}
                </div>
              </div>
            </a>
            ...
            <a href={SITE.phoneHref} className="group flex items-start gap-4">
              ...
              <div className="min-w-0 text-left">
                ...
                <div className="mt-0.5 text-sm text-white group-hover:text-gold-soft transition">
                  +91 {SITE.phone}
                </div>
              </div>
            </a>
      ...
      <div className="relative z-10 bg-black/40 border-t border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/70">
            ...
            <span className="text-gold font-semibold">Durga Hardware and Plywood</span> All Rights
            Reserved.
          </p>
          <p className="text-sm text-white/70">
