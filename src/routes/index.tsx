...
const testimonials = [
  {
    ...
    role: "Homeowner, Benz Circle",
    text: "Bought plywood and laminates for my new flat here. Genuine Century products, billing was clear and Bharat garu personally helped us choose. Very happy with the quality.",
    rating: 5,
    img: t1,
  },
  {
    name: "Sai Priya Yalamanchili",
    role: "Interior Designer",
    text: "I source most of my materials from Durga Hardware. Huge range of veneers and the staff actually know their products. Delivery to my sites is always on time.",
    rating: 5,
    img: t2,
  },
  {
    ...
    text: "Best hardware shop in Vijayawada for Hettich and Hafele fittings. Prices are fair and they never push you towards costly items. Been buying here for 3 years.",
    rating: 5,
    img: t3,
  },
  {
    name: "Sridevi Pillutla",
    role: "Homeowner, Patamata",
    text: "Got our modular kitchen accessories from here. The team patiently explained every option and helped us stay within budget. Highly recommend this store.",
    rating: 5,
    img: t4,
  },
  {
    name: "Rajesh Vutukuri",
    role: "Architect",
    text: "Reliable place for premium plywood and profile doors. Stock is always available and the brands are authentic. My clients are always satisfied with the finish.",
    rating: 4,
    img: t5,
  },
  {
    name: "Anusha Gadiraju",
    role: "Homeowner, Gunadala",
    text: "Friendly and honest staff. We compared a few shops in the city and Durga gave us the best rate on laminates with original brand bills. Will come back again.",
    rating: 5,
    img: t6,
  },
];
